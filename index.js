...
Car.prototype.brake = function (value) {
  this.speed -= value;
  console.log(
    `Автомобіль ${this.brand} ${this.model} зменшив швидкість ${this.speed} км/год`
  );
};
...
const kilometers = car.drive.bind(car);
kilometers(100);
/*
...
function ElectricCar(brand, model, year, mileage, batteryCapacity) {
  ...
  if (new.target) {
    ...
    console.log("Помилка. Конструктор має бути викликаний з 'new'");
  }
}
